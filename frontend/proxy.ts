...
export async function proxy(request: NextRequest) {
  ...
  // Is protected route, we need verify if the user is authenticated
  try {
    // 1. Validate if the user have the jwt token
    // 2. If the user exist on database
    ...
    // In this point we leave continue the user
